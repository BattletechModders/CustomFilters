...
internal class OptionsPanel
{
    ...
    private readonly TagManagerSettings _settings = TagManagerFeature.Settings;
    ...
    internal OptionsPanel(Action<TagManagerSettings.TagsFilterSet> loadCallback)
    {
        ...
        {
            if (_settings.SkirmishOptionsPresets != null)
            {
                ...
                hlg.spacing = 20;
                hlg.padding.bottom = 10;
                foreach (var preset in _settings.SkirmishOptionsPresets)
                {
            ...
            if (_settings.SkirmishOptionsComponentGroup != null)
            {
                AddOptionsGroup(_settings.SkirmishOptionsComponentGroup);
            }

            if (_settings.SkirmishOptionsMechGroups != null)
            {
                foreach (var group in _settings.SkirmishOptionsMechGroups)
                {
    ...
    private void RefreshCount()
    {
        ...
        var warningSuffix = count > _settings.SkirmishOverloadWarningCount
    ...
    private void CheckFilteredCountAndLoadCallback(TagManagerSettings.TagsFilterSet filter)
    {
        ...
        var max = _settings.SkirmishOverloadWarningCount;
        if (count > max)
        {
            GenericPopupBuilder
    ...
    {
        var defaults = _settings.SkirmishOptionsDefault;
        ...
        if (_settings.SkirmishOptionsComponentGroup != null)
        {
            componentsFilter = new()
            {
                ContainsAny = CombineOrDefault(
                    _settings.SkirmishOptionsComponentGroup.Options
        ...
        var filterSet = new TagManagerSettings.TagsFilterSet
        {
            ...
            Mechs = new()
            {
                ...
                OptionsGroups = _settings.SkirmishOptionsMechGroups
            },
